...
@EnableKafka
@Configuration
public class KafkaProducerConfigurationCase1Config3 extends AbstractKafkaProducerConfigurationCaseConfig {

    public KafkaProducerConfigurationCase1Config3(KafkaProperties kafkaProperties) {
        super(kafkaProperties);
    }

    @Override
    @Bean("kafkaTemplateCase1Config3")
    ...
    protected final Map<String, Object> getProducerConfig() {
        ...
        properties.putAll(kafkaProperties.getSettingsForCase_1Config_3());
