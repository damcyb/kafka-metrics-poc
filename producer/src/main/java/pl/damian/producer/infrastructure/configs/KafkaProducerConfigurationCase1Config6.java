...
@EnableKafka
@Configuration
public class KafkaProducerConfigurationCase1Config6 extends AbstractKafkaProducerConfigurationCaseConfig {

    public KafkaProducerConfigurationCase1Config6(KafkaProperties kafkaProperties) {
        super(kafkaProperties);
    }

    @Override
    @Bean("kafkaTemplateCase1Config6")
    ...
    protected final Map<String, Object> getProducerConfig() {
        ...
        properties.putAll(kafkaProperties.getSettingsForCase_1Config_6());
