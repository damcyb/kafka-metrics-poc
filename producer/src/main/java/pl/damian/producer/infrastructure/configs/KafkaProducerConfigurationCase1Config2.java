...
@EnableKafka
@Configuration
public class KafkaProducerConfigurationCase1Config2 extends AbstractKafkaProducerConfigurationCaseConfig {

    public KafkaProducerConfigurationCase1Config2(KafkaProperties kafkaProperties) {
