...
@EnableKafka
@Configuration
public class KafkaProducerConfigurationCase1Config12 extends AbstractKafkaProducerConfigurationCaseConfig {

    public KafkaProducerConfigurationCase1Config12(KafkaProperties kafkaProperties) {
        super(kafkaProperties);
    }

    @Override
    @Bean("kafkaTemplateCase1Config12")
    ...
    protected final Map<String, Object> getProducerConfig() {
        ...
        properties.putAll(kafkaProperties.getSettingsForCase_1Config_12());
