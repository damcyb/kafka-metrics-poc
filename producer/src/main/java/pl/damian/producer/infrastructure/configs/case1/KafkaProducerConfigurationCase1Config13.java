...
@EnableKafka
@Configuration
public class KafkaProducerConfigurationCase1Config13 extends AbstractKafkaProducerConfigurationCaseConfig {

    public KafkaProducerConfigurationCase1Config13(KafkaProperties kafkaProperties) {
        super(kafkaProperties);
    }

    @Override
    @Bean("kafkaTemplateCase1Config13")
    ...
    protected final Map<String, Object> getProducerConfig() {
        ...
        properties.putAll(kafkaProperties.getSettingsForCase_1Config_13());
