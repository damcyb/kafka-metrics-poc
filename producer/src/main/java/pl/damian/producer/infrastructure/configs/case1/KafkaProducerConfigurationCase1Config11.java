...
@EnableKafka
@Configuration
public class KafkaProducerConfigurationCase1Config11 extends AbstractKafkaProducerConfigurationCaseConfig {

    public KafkaProducerConfigurationCase1Config11(KafkaProperties kafkaProperties) {
        super(kafkaProperties);
    }

    @Override
    @Bean("kafkaTemplateCase1Config11")
    ...
    protected final Map<String, Object> getProducerConfig() {
        ...
        properties.putAll(kafkaProperties.getSettingsForCase_1Config_11());
